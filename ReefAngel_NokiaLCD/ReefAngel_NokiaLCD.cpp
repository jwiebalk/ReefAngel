...
//int ReefAngel_NokiaLCD::ChangeData(int data, int change, int dmin, int dmax)
//{
//    data += change;
//    if (data>dmax) data=dmin;
//    if (data<dmin) data=dmax;
//    return data;
//}
//
//void ReefAngel_NokiaLCD::KeyChange (int change)
//{
///*
//    if (menu==40 && selmenu<=6)
//    {
//        switch (selmenu)
//        {
//            case 1:
//                TempiDateMonth=ChangeData(TempiDateMonth, change, 1, 12);
//                if (TempiDateMonth==2 && IsLeapYear(2000+TempiDateYear)==1 && TempiDateDay>29)
//                {
//                TempiDateDay=29;
//                }
//                else
//                {
//                if (TempiDateDay>MonthDays[TempiDateMonth]) TempiDateDay=MonthDays[TempiDateMonth];
//                }
//                break;
//            case 3:
//                TempiDateYear=ChangeData(TempiDateYear, change, 0, 99);
//                if (TempiDateMonth==2 && IsLeapYear(2000+TempiDateYear)==0 && TempiDateDay>28) TempiDateDay=28;
//                if (TempiDateMonth==2 && IsLeapYear(2000+TempiDateYear)==1 && TempiDateDay>29) TempiDateDay=29;
//                break;
//            case 4:
//                TempiTimeHour=ChangeData(TempiTimeHour, change, 1, 12);
//                break;
//            case 5:
//                TempiTimeMin=ChangeData(TempiTimeMin, change, 0, 59);
//                break;
//            case 6:
//                TempiTimeAMPM=ChangeData(TempiTimeAMPM, change, 0, 1);
//                break;
//        }
//        DrawDateTime(selmenu);
//    }
//    if (menu==50 && selmenu<=6)
//    {
//        switch (selmenu)
//        {
//            case 1:
//                TempiDawnHour=ChangeData(TempiDawnHour, change, 1, 12);
//                break;
//            case 2:
//                TempiDawnMin=ChangeData(TempiDawnMin, change, 0, 59);
//                break;
//            case 3:
//                TempiDawnAMPM=ChangeData(TempiDawnAMPM, change, 0, 1);
//                break;
//            case 4:
//                TempiDuskHour=ChangeData(TempiDuskHour, change, 1, 12);
//                break;
//            case 5:
//                TempiDuskMin=ChangeData(TempiDuskMin, change, 0, 59);
//                break;
//            case 6:
//                TempiDuskAMPM=ChangeData(TempiDuskAMPM, change, 0, 1);
//                break;
//        }
//        DrawDawnDusk(selmenu);
//    }
//    if (menu==60 && selmenu==1)
//    {
//        TempLEDOverheat=ChangeData(TempLEDOverheat, change, 50, 150);
//        DrawOption(TempLEDOverheat,1,45,55,"F",".");
//    }
//    if (menu==70 && selmenu==1)
//    {
//        TempLEDPWMDaylight=ChangeData(TempLEDPWMDaylight, change, 0, 100);
//        DrawOption(TempLEDPWMDaylight,1,75,45,"%","");
//    }
//    if (menu==70 && selmenu==2)
//    {
//        TempLEDPWMActinic=ChangeData(TempLEDPWMActinic, change, 0, 100);
//        DrawOption(TempLEDPWMActinic,1,75,75,"%","");
//
//    }
//    if (menu==80 && selmenu==1)
//    {
//        TempATOTimeout=ChangeData(TempATOTimeout, change, 1, 999);
//        DrawOption(TempATOTimeout,1,45,55,"s","");
//    }
//    if (menu==90 && selmenu==1)
//    {
//        TempWM1Timer=ChangeData(TempWM1Timer, change, 1, 255);
//        DrawOption(TempWM1Timer,1,78,45,"s","");
//    }
//    if (menu==90 && selmenu==2)
//    {
//        TempWM1Pattern=ChangeData(TempWM1Pattern, change, 1, 2);
//        DrawPattern(TempWM1Pattern,1,106,45);
//    }
//    if (menu==90 && selmenu==3)
//    {
//        TempWM2Timer=ChangeData(TempWM2Timer, change, 1, 255);
//        DrawOption(TempWM2Timer,1,78,75,"s","");
//    }
//    if (menu==90 && selmenu==4)
//    {
//        TempWM2Pattern=ChangeData(TempWM2Pattern, change, 1, 2);
//        DrawPattern(TempWM2Pattern,1,106,75);
//    }
//    if (menu==100 && selmenu<4)
//    {
//        TempSensor[selmenu]=ChangeData(TempSensor[selmenu], change, 0, 3);
//        DrawTempSensor(selmenu);
//    }
//*/
//}
//
...
//    //if (Option==99 || Option==9) e.lcd_clear(WHITE,x1-8,y-8,x2+4,y+15);
//    if (Selected>40) Selected=0;
//    if (Selected!=0)
//    //  {
//    //    bcolor=WHITE;
//    //    e.lcd_draw_text(BLACK,WHITE,x1,y-8,"   ");
//    //    e.lcd_draw_text(BLACK,WHITE,x1,y+8,"   ");
//    //  }
//    //  else
//    {
...
//    DrawText(COLOR_BLACK,bcolor,x1,y,text);
//    DrawText(COLOR_BLACK,bcolor,x3,y-5,subunit);
//    DrawText(COLOR_BLACK,bcolor,x2,y,unit);
//    if (subunit!="")
//    {
